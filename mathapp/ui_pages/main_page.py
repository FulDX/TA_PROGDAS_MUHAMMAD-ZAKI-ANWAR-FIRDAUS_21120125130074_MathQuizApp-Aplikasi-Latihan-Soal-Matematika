...
class MainMenu(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.title_label = ttk.Label(self, text="Math Quiz App", background=controller.page_bg, foreground="white", font=("Helvetica", 48, "bold"))
        ...
        self.mulai_button = tk.Button(self, text="Mulai", bg="#6EFFA8", fg="#FFFFFF", font=("Helvetica", 36, "bold"), activebackground="#6EFFA8", activeforeground="#FFFFFF", borderwidth=0, highlightthickness=0)
        self.mulai_button.place(x=270, y=171, width=260, height=84)
        apply_click_effect(self.mulai_button)

        self.endless_button = tk.Button(self, text="Endless", bg="#FF4E51", fg="#FFFFFF", font=("Helvetica", 36, "bold"), activebackground="#FF4E51", activeforeground="#FFFFFF", borderwidth=0, highlightthickness=0)
        self.endless_button.place(x=270, y=288, width=260, height=84)

        self.keluar_button = tk.Button(self, text="Keluar", bg="#000000", fg="#FFFFFF", font=("Helvetica", 36, "bold"), activebackground="#000000", activeforeground="#FFFFFF", borderwidth=0, highlightthickness=0)
