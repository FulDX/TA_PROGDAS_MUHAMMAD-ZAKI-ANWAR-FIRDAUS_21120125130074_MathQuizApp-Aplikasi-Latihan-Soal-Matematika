...
class StartPage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.kalkulus_button = tk.Button(
            self, 
            text="Kalkulus", 
            bg="#FF3232", 
            fg="#FFFFFF", 
