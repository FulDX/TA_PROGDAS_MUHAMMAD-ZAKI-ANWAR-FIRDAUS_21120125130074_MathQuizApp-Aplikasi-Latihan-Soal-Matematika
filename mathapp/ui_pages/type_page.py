...
class BasicPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.aritmetika_button = tk.Button(
            self, 
            text="Aritmetika", 
            bg="#6EFFA8", 
            fg="#FFFFFF", 
        ...
        self.explog_button = tk.Button(
            self, 
            text="Eksponen & Logaritma", 
            bg="#6EFFA8", 
            fg="#FFFFFF", 
            font=("Helvetica", 36, "bold"), 
            activebackground="#6EFFA8", 
...
class DeretPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.aritmetika_ser_button = tk.Button(
            self, 
            text="Deret Aritmetika", 
            bg="#FFA14E", 
            fg="#FFFFFF", 
            font=("Helvetica", 36, "bold"), 
            activebackground="#FFA14E", 
            activeforeground="#FFFFFF", 
            borderwidth=0, 
            highlightthickness=0
        )
        ...
        self.geometri_serfin_button = tk.Button(
            self, 
            text="Deret Geometri Tentu", 
            bg="#FFA14E", 
            fg="#FFFFFF", 
            font=("Helvetica", 36, "bold"), 
            activebackground="#FFA14E", 
        ...
        self.geometri_serinf_button = tk.Button(
            self, 
            text="Deret Geometri Tak Tentu", 
            bg="#FFA14E", 
            fg="#FFFFFF", 
            font=("Helvetica", 36, "bold"), 
            activebackground="#FFA14E", 
...
class KalkulusPage(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.limit_button = tk.Button(
            self, text="Limit", 
            bg="#FF3232", 
            fg="#FFFFFF", 
            font=("Helvetica", 36, "bold"), 
            activebackground="#FF3232",
            activeforeground="#FFFFFF", 
            borderwidth=0, 
            highlightthickness=0
        )
